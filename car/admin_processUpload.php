...
echo $currentfolder;
$destination_folder = $currentfolder . '/finished_uploads/'; //upload directory ends with / (slash)
...
$stmt = "INSERT INTO " . $db_table_prefix . "finished_filesRepository (
        file_ID,
        user_id,
        current_folder,
        destination_folder,
...
header("Location: delete.php?userId=$user_id"); /* Redirect browser */
exit();
